...
const pages = ['/', '/portfolio', '/portfolio/castlecrag-terrace', '/portfolio/middle-cove-deck', '/portfolio/castlecrag-arrival', '/portfolio/northbridge-terraces', '/portfolio/willoughby-courtyard', '/services', '/contact'];
