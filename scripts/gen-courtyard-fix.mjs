...
const jobs = [
  [`${OUT}/courtyard-1.jpg`, 'courtyard-2', 'This exact same walled courtyard, dramatic ground-level camera almost on the bluestone paving looking along the joint lines toward the corner where the batten screen meets the white wall, strong raking afternoon shadows across the stone.'],
  [`${OUT}/courtyard-1.jpg`, "courtyard-4", 'This exact same walled courtyard viewed from above at a steep downward angle, showing the full bluestone paving pattern, the bench running along one edge and the batten screen foreshortened.'],
];
