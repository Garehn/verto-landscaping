...
const cards: { title: string; body: string; image: string; href: string }[] = [
  {
    ...
    image: '/images/proj/pool-terrace/aerial.jpg',
    href: '/services#design',
  },
  {
    title: 'Paving & Stone',
    body: 'All paving materials and stonework, laid to line.',
    image: '/images/proj/cobble-court/cobble-texture.jpg',
    href: '/services#paving',
  },
  {
    title: 'Retaining and outdoor living structures',
    body: 'From sandstone block and masonry walls to outdoor structures such as garages, pergolas and the like.',
    image: '/images/proj/site/timber-lawn.jpg',
    href: '/services#retaining',
  },
  {
    title: 'Pools & Decking',
    body: 'Pool tiling, hardwood and composite decking surrounded by glass, aluminium or stainless fencing.',
    image: '/images/proj/pool-terrace/pool-detail.jpg',
    href: '/services#pools',
  },
];
